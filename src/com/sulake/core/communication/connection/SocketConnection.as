package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1242:int = 10000;
      ...
      private var var_892:IEncryption;
      
      private var var_743:int;
      
      private var var_272:ByteArray;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_337 = param2;
         var_272 = new ByteArray();
         var_891 = new MessageClassManager();
         var_71 = new Socket();
         var_353 = new Timer(const_1242,1);
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_743));
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         var_353.stop();
         var_1278 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_743));
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_615.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_352)
         {
         ...
         if(var_892 != null)
         {
            _loc3_ = var_892.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_272.writeByte(var_71.readUnsignedByte());
         }
         logConnection(">>[SOCKET]: " + var_272.toString());
      }
      ...
      {
         var_337.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_743));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_743));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = var_615.getMessages(var_272,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = var_891.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = var_337.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  else
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = var_337.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(var_272,offset);
               var_272 = temp;
               logConnection("[SOCKET REST] offset: " + offset + " rest: " + var_272.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_743));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         ...
         var_1278 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_743));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_892 + "\n");
      }
   }
}
