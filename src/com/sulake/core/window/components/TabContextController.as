package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1085:String = "content";
      ...
      protected var var_1706:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1706 == null)
         {
            var_1706 = findChildByTag(TabContextController.const_1085) as IWindowContainer;
         }
         return var_1706;
      }
      ...
      {
         return var_1007.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1007 == null)
         {
            var_1007 = findChildByTag(TabContextController.const_1084) as ITabSelectorWindow;
            if(var_1007 != null)
            {
               var_1007.procedure = selectorEventProc;
            }
         }
         return var_1007;
      }
      ...
      {
         return !!var_941 ? selector.iterator : null;
      }
