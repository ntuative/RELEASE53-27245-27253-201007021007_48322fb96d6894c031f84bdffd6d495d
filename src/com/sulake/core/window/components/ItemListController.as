package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_2479:Number = 0.0;
      ...
      protected var var_1473:Boolean = false;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_825:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_91 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_328;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_167 = var_680 || !testParamFlag(WindowParam.const_36);
         _container = var_16.create("_CONTAINER","",WindowType.const_314,WindowStyle.const_358,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_261,containerEventHandler);
      ...
      {
         return new Rectangle(var_580 * maxScrollH,var_581 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_261,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1060,_spacing,PropertyStruct.const_66,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1062,var_825,PropertyStruct.const_61,var_825 != const_1448));
         _loc1_.push(new PropertyStruct(const_1061,var_579,PropertyStruct.const_61,var_579 != const_1447));
         _loc1_.push(new PropertyStruct(const_1063,var_1191,PropertyStruct.const_61,var_1191 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_581 = param1;
            _container.y = -var_581 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_78);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1063:
                  ...
                  break;
               case const_1062:
                  var_825 = _loc2_.value as Boolean;
                  break;
            }
         }
