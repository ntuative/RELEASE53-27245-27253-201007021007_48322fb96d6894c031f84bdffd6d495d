package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_773:String = "margin_top";
      
      private static const const_1069:String = "_HEADER";
      
      private static const const_774:String = "margin_right";
      
      private static const const_1068:String = "_SCALER";
      
      private static const const_1067:String = "_TITLE";
      
      private static const const_1066:String = "_CONTENT";
      
      private static const const_772:String = "margin_left";
      ...
      private var var_1201:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_772,_loc3_.left,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_773,_loc3_.top,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_774,0 - _loc3_.right,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_771,0 - _loc3_.bottom,PropertyStruct.const_66,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1201 == null)
         {
            var_1201 = findChildByTag(const_1069) as IHeaderWindow;
            if(!var_1201)
            {
      ...
      {
         return findChildByTag(const_1068) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_274,false);
         }
