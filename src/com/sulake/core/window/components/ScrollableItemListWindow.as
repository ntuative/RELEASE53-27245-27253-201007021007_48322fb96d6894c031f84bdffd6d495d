package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_898:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_357)
         {
            ...
            if(var_357)
            {
               var_357.addEventListener(WindowEvent.const_287,scrollBarEventProc);
               var_357.addEventListener(WindowEvent.const_223,scrollBarEventProc);
            }
         }
         return var_357;
      }
      ...
      override public function dispose() : void
      {
         if(var_357)
         {
            var_357.removeEventListener(WindowEvent.const_287,scrollBarEventProc);
            var_357.removeEventListener(WindowEvent.const_223,scrollBarEventProc);
            var_357 = null;
         }
         if(var_898)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_898)
         {
            var_898 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_898;
      }
