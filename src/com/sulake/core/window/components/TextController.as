package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_688 * maxScrollH,var_394 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_826)
         {
            context.removeLocalizationListener(var_339,this);
         }
         if(var_69 != null)
         {
            var_69.dispose();
      ...
      {
         var_688 = param1;
         _field.scrollH = var_688 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_339 = param1;
         if(var_339.charAt(0) == "$" && var_339.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_339.slice(2,var_339.indexOf("}")),this);
            var_826 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1020,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_508,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_508,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_662,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_662,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_662,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
