package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_395:Array;
      
      private static const const_789:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1831 = new Dictionary();
         TypeCodeTable.fillTables(var_1515,var_1831);
         var_1231 = new Dictionary();
         var_1832 = new Dictionary();
         StateCodeTable.fillTables(var_1231,var_1832);
         ...
         {
            var_395 = new Array();
            var_395.push(WindowState.const_69);
            var_395.push(WindowState.const_72);
            var_395.push(WindowState.const_101);
            var_395.push(WindowState.WINDOW_STATE_SELECTED);
            var_395.push(WindowState.const_81);
            var_395.push(WindowState.const_76);
            var_395.push(WindowState.const_96);
            var_395.push(WindowState.const_90);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "ModMessageMessageComposer" : false;
                  ...
                  addSkinRenderer(var_1515[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_715[param1];
      ...
      {
         var _loc3_:Array = var_716[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_716[param1] = new Array(SkinContainer.const_789);
         }
         var_716[param1][param2] = param3;
         if(true)
         {
            var_715[param1] = new Array(SkinContainer.const_789);
         }
         var_715[param1][param2] = param4;
      }
