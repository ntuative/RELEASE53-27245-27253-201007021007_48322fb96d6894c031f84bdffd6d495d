package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_935:uint = 256;
      
      protected static var var_689:uint = 0;
      
      protected static var var_396:uint = 0;
      
      public static const const_944:uint = 2;
      
      public static const const_1628:uint = 128;
      
      public static const const_1521:uint = 64;
      
      public static const const_565:uint = 4;
      
      public static const const_1309:uint = 0;
      
      public static const const_1249:uint = 16;
      
      public static const const_700:uint = 1;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1249:
               ...
               break;
            case GraphicContext.const_565:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_935:
               break;
            case GraphicContext.const_1309:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_686)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_396 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_686)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_396 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
