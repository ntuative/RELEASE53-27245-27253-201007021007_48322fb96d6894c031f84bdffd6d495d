package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseTemplateList(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map, param5:IAssetLibrary) : void
      {
         ...
         while(_loc8_ < _loc7_)
         {
            ...
            if(_loc13_.length() > 0)
            {
               ...
               {
                  _loc16_ = _loc15_[0];
                  method_9(param1,_loc12_,_loc15_,param4);
               }
            }
      ...
      protected static function method_9(param1:ISkinRenderer, param2:BitmapSkinTemplate, param3:XMLList, param4:Map) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc15_:* = null;
         var _loc5_:String = param2.attribute("name");
         var _loc6_:* = param2.attribute("transparent") == "ModMessageMessageComposer";
