package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1608:String = "_INCLUDE";
      ...
      protected var var_1015:Dictionary;
      
      protected var var_1478:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1477:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1196,var_1197);
         var_1015 = new Dictionary();
         var_1477 = new Dictionary();
         ParamCodeTable.fillTables(var_1015,var_1477);
         var_1478 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1153,"");
         return param1.replace(const_1152,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1015)
            {
               delete var_1015[_loc1_];
            }
            for(_loc1_ in var_1477)
            {
               delete var_1477[_loc1_];
            }
            var_1478.dispose();
            var_1478 = null;
            var_16 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "ModMessageMessageComposer";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "ModMessageMessageComposer";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "ModMessageMessageComposer";
