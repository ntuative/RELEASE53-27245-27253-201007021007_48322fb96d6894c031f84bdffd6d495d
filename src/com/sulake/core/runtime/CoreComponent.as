package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private var var_278:LibraryLoaderQueue;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_682 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_523 = new Array();
         var_624 = new Array();
         var_220 = param1;
         var _loc3_:int = 0;
      ...
      {
         return var_241 - getNumberOfFilesPending();
      }
      ...
      private function debugFrameUpdateHandler(param1:Event) : void
      {
         ...
         var _loc3_:uint = _loc2_ - var_277;
         var_277 = _loc2_;
         _loc4_ = 0;
         while(_loc4_ < CoreComponent.const_142)
         {
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         if(var_278 == null)
         {
            var_278 = new LibraryLoaderQueue(var_682);
         }
         try
         {
            ...
            if(node != null)
            {
               ...
               for each(item in list)
               {
                  ...
                  loader = new ZipLoader(context,true,var_682);
         ...
         {
            error("Failed to parse zip libraries from config xml!",true,Core.const_189,e);
         }
         try
         {
            ...
            if(node != null)
            {
               ...
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_682);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  var_278.push(loader);
                  loader.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,updateLoadingProcess);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_189,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_189,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_189,e);
         }
         if(!disposed)
         {
      ...
      private function profilerFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msSinceLastUpdate:uint = msCurrentTime - var_277;
         var_277 = msCurrentTime;
         var_916.start();
         criticality = 0;
         while(criticality < CoreComponent.const_142)
         {
            var_624[criticality] = 0;
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_142)
         {
            ...
            {
               if(var_624[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_762)
               {
                  var_762.dispatchEvent(new LibraryProgressEvent(_loc2_.url,var_241 - 0,var_241,_loc2_.elapsedTime));
               }
            }
         }
         if(false)
