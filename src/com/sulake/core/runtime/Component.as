package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_895:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_193.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1013 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1013);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1188 & const_895)
         {
            if(_loc3_ == 0)
            {
               if(var_193.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_193.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_447 + "]";
      }
