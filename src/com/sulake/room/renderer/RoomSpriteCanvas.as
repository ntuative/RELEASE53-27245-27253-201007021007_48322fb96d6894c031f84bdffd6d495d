package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1932:Number = -1.0E7;
      
      private var var_1935:Number = -1.0E7;
      
      private var var_2489:int = 0;
      
      private var var_498:RoomObjectCache;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_312 = new Map();
         var_498 = new RoomObjectCache(_loc6_);
      ...
      {
         var_498.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_882 == 0)
         {
            checkMouseHits(var_1064.x,var_1064.y,MouseEvent.MOUSE_MOVE);
         }
         var_882 = 0;
         ++var_758;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_52.graphics.beginFill(var_2489);
      ...
      {
         var _loc11_:Number = param1 - var_732 / 2;
         var _loc12_:Number = param2 - var_733 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_732 != var_1934 || var_733 != var_1933)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
      ...
      public function dispose() : void
      {
         ...
         if(var_500 != null)
         {
            ...
            {
               cleanSprite(var_500[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_500 = [];
         }
         ...
         while(_loc1_ < var_312.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1065 != null)
                  {
                     var_1065.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_758,geometry);
                  }
                  else
                  {
                     _loc5_ = _loc4_.method_2();
                     if(_loc5_ != null)
                     {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1064.x = param1;
         var_1064.y = param2;
         if(var_882 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1549;
         }
         var_1549 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_882;
         return var_1549;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_499.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_499.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1932 || param2 != var_1935)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_499.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_499.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_500.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.needsUpdate(_loc3_.method_14,_loc3_.updateId))
            {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_498.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_498.getObjectCache(param2);
         ...
         _loc13_ += int(var_732 / 2);
         _loc14_ += int(var_733 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_732 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_733))
                  {
