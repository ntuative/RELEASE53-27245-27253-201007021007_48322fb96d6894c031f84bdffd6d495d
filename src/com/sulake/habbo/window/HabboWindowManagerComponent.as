package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1461:ProfilerAgentTask;
      
      private var var_1458:IEventDispatcher;
      
      private var var_2526:uint = 0;
      
      private var var_1460:ProfilerAgentTask;
      
      private var var_1459:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1458 = Component(param1).events;
         var_468 = new Array();
      ...
      {
         return var_254[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_254[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_816 = new SkinContainer(_loc3_.content as XML,assets);
         var_815 = new WindowRenderer(var_816);
         var_254 = new Array(const_374);
         var _loc5_:int = 0;
         while(_loc5_ < const_374)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_815,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_254[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_236 = var_254[const_1179];
         ...
         var_236.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1387,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_254[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_254.pop()).dispose();
            }
            var_254 = null;
            while(false)
            {
      ...
      {
         return var_254[param1].getDesktopWindow().getChildAt(var_236.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1459 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1459 = new ProfilerOutput(_loc3_,this,var_815);
               var_1461 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1461);
               var_1460 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1460);
               var_1176 = true;
            }
         }
      }
      ...
      {
         return var_816.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1001.length > 0)
         {
            var_1458.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_374 - 1;
            while(_loc2_ >= 0)
            {
               var_254[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1176)
         ...
         var_1458.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_374)
         {
            var_254[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1176)
         {
         ...
         if(WindowContext.var_1001.length > 0)
         {
            WindowContext.var_1001.flush();
         }
         if(WindowContext.var_1469.length > 0)
         {
            WindowContext.var_1469.flush();
         }
         var_1458.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1370,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1396,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1343,param2.name + ": " + param2.toString());
            }
         }
      }
   }
