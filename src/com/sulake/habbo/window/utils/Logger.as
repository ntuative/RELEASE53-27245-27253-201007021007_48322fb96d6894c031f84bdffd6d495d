package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1657:ICoreWindowManager;
      ...
      {
         var_1657 = param2 as ICoreWindowManager;
         _window = var_1657.create("Logger::Output",HabboWindowType.const_112,WindowStyle.const_358,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_381 = var_1657.create("Logger::Output::Text",HabboWindowType.const_1,WindowStyle.const_358,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
         var_381.multiline = true;
         var_381.background = true;
         var_381.border = true;
         var_381.fontFace = "Volter";
         var_381.fontSize = 9;
         IWindowContainer(_window.findChildByName("content_area")).addChild(var_381);
