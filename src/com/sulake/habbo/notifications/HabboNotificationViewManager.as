   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < var_242.length)
         {
            ...
            if(_loc1_ + HabboNotificationItemView.const_711 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_711 + const_519;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2053,var_399,_toolbar);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_711 < 540;
      }
   }
}
