package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_2192 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_384 != null)
         {
            var_384.events.removeEventListener(BadgeImageReadyEvent.const_115,onBadgeImageReady);
            var_384 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_782,var_2192);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_782,var_782));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_782,var_782));
         _localizations.registerParameter(param1,"level",var_1936.toString());
         _localizations.registerParameter(param1,"name",var_384.userName);
         _localizations.registerParameter(param1,"realname",var_384.realName);
      }
   }
}
