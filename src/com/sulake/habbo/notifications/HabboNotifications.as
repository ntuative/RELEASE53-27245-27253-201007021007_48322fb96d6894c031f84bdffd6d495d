package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1162:String = "badges";
      
      private static const const_1165:String = "pet_inventory";
      
      private static const const_1163:String = "pixelbalance";
      
      private static const const_1168:String = "credits";
      
      private static const const_1166:String = "inventory";
      
      private static const const_1164:String = "friendlist";
      
      private static const const_1169:String = "selectfurni";
      
      private static const const_1167:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_658:ParkBusDialogManager;
      ...
      private var var_802:ClubEndingNotification;
      ...
      private var var_803:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_973);
         }
         var _loc6_:Map = var_973["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1218);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_803 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_215 == null)
         {
            return;
         }
         var_215.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_922)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1392);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_215.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_215.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_84:
               ...
               break;
            case CatalogPageMessageProductData.const_231:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2334)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1056);
            var_2334 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1162:
               if(var_11 != null)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_271);
               }
               break;
            case const_1167:
               break;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1056,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_616.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_54);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1010,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_163 || param2.type == WindowEvent.const_618)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_458.isSpaceAvailable() && false)
         {
            var_458.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_658 == null)
         {
            var_658 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_658 != null)
         {
            var_658.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1163.splice(0,1);
      ...
      private function method_13(param1:PetLevelNotificationEvent) : void
      {
         if(param1 == null)
         {
            return;
         ...
         var _loc4_:IAvatarImage = var_616.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_54);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_384);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_384.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc9_ = var_384.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_384.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1284,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_616.createAvatarImage(param2,AvatarScaleType.const_54);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1163.push(_loc8_);
         return var_1163.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1200)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_802 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_215 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_659.events.addEventListener(HabboToolbarEvent.const_91,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_215.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_384.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_975);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_975);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_215.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_91)
         {
            ...
            var_458 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_973["styles"],var_973["view"],var_659);
            ...
            _communication.addHabboConnectionMessageEvent(new PetLevelNotificationEvent(method_13));
            ...
            registerUpdateReceiver(var_458,1);
            registerUpdateReceiver(this,2);
            var_384.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImage);
