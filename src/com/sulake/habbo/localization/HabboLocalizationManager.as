package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1567:String = "%";
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1567);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1567,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         if("ModeratorActionResultMessageParser" == var_126.getKey("use.default.localizations","ModeratorActionResultMessageParser"))
         {
            _loc4_ = var_126.getKey("external.texts.txt","external_texts.txt");
            super.loadLocalizationFromURL(_loc4_);
         }
         var _loc3_:int = 1;
         while(var_126.keyExists("localization." + _loc3_))
         {
            _loc5_ = var_126.getKey("localization." + _loc3_,"");
            _loc6_ = var_126.getKey("localization." + _loc3_ + ".name","");
            _loc7_ = var_126.getKey("localization." + _loc3_ + ".url","");
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            (var_126 as Component).events.addEventListener(HabboConfigurationEvent.INIT,onConfigurationReady);
         }
      }
