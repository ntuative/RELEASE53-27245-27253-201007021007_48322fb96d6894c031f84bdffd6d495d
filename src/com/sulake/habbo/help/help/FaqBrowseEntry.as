package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_238.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_238.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_238.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_238.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_238 != null)
               {
                  _loc3_ = var_238.category;
                  main.showUI(HabboHelpViewEnum.const_275);
                  main.tellUI(HabboHelpViewEnum.const_275,_loc3_);
               }
               break;
            case "help_faq_next_entry":
               if(getNextItem() != null)
               {
                  main.tellUI(HabboHelpViewEnum.const_241,getNextItem());
               }
               break;
            default:
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || var_238 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = var_238.category;
         if(_loc2_ == null)
         {
            return null;
         }
