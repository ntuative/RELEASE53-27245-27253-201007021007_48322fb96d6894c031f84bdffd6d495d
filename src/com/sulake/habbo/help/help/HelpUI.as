package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1755:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","27245-27253-201007020956");
         _toolbar = param5;
         var_105 = new Map();
         var_105.add(HabboHelpViewEnum.const_1336,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_144,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_430,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_275,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_588,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_301,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_749,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         ...
         var_105.add(HabboHelpViewEnum.const_987,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_660,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      {
         return var_105.getValue(var_261);
      }
      ...
      {
         var_1757 = param1;
         var _loc2_:IHelpViewController = var_105.getValue(HabboHelpViewEnum.const_144) as IHelpViewController;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1492;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_382));
      }
