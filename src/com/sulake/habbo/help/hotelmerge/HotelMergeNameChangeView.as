package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private var var_880:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _controller.localization.registerParameter("help.tutorial.name.available","name",var_382);
      ...
      private function showSelectionView() : void
      {
         if(!var_649)
         {
            var_649 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_649)
            {
               return;
            }
            _window.content.addChild(var_649);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "confirm_name_button":
               _controller.changeName(var_382);
               break;
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1403 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1003:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1184:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1185 || param1 == ChangeUserNameResultMessageEvent.var_1184)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_880 = new NameSuggestionListRenderer(_controller);
         var _loc6_:int = var_880.render(param3,_loc5_);
         var _loc7_:int = 0;
