package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1286)
         {
            gotoRoom(var_1963,var_1965,var_1287);
            var_1286 = false;
            var_1287 = "";
         }
      }
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_109,_loc4_));
            _loc4_.dispose();
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_947:
                  break;
               case RoomSessionHandler.const_844:
                  break;
               case RoomSessionHandler.const_613:
