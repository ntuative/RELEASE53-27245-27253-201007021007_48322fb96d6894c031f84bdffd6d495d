package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1328:String = "normal_badge";
      ...
      private const const_1485:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1485,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1485 + param1;
         ...
         switch(param2)
         {
            case const_1328:
               if(var_126 != null)
               {
                  _loc5_ = var_126.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_883:
               if(var_126 != null)
               {
                  if(var_126 != null)
                  {
                     _loc5_ = var_126.getKey("group.badge.url");
