package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1047:UserDataManager;
      ...
      {
         if(var_36 == RoomSessionEvent.const_303 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_98;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1047 as IUserDataManager;
      }
