package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_868:RoomLayout;
      ...
      private var var_1055:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_495 = new Timer(100);
         var_495.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_39 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1055 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_495)
         {
            var_495.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_495.reset();
            var_495 = null;
         }
      }
      ...
      {
         var_1055.goBackToInitialState();
         var_1055.input.textBackgroundColor = 4294967295;
         var_868 = var_39[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_42,HabboWindowParam.const_71,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1055.getText();
      ...
      {
         var _loc1_:Boolean = var_1055.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_868.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1241 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1241 = true;
            _loc3_.y = 1;
