package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1667,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1666,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1667 = IButtonWindow(find("top_tab"));
         var_1666 = IButtonWindow(find("obj_tab"));
         var_2304 = IWindowContainer(find("tile_grid"));
         var_2305 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1667,onTopTabButton);
         Util.setProcDirectly(var_1666,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2304;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_475)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2305;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_42,HabboWindowParam.const_71,new Rectangle(0,0,param1.width,66)));
