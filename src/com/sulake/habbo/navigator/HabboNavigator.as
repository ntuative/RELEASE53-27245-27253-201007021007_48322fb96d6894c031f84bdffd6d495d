package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_969:RoomCreateViewCtrl;
      
      private var var_2177:RoomThumbnailRenderer;
      
      private var _toolbar:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_552:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_426:Tabs;
      
      private var var_291:MainViewCtrl;
      
      private var var_2314:Array;
      
      private var var_1053:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_291 = new MainViewCtrl(this);
         var_552 = new RoomInfoViewCtrl(this);
         var_969 = new RoomCreateViewCtrl(this);
         var_2177 = new RoomThumbnailRenderer(this);
         var_1053 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_426 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_291.startSearch(Tabs.const_247,Tabs.const_355,param1);
         var_291.mainWindow.activate();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_126.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_552.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_291.startSearch(Tabs.const_269,Tabs.const_240);
         var_426.getTab(Tabs.const_269).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_291.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
