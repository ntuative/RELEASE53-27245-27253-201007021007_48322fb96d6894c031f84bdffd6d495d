package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2177 = new RoomThumbnailRenderer(param1);
         var_947 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_183,var_119.ownerName);
      ...
      private function method_4() : void
      {
         ...
         var_947.refreshTags(_loc1_,var_119.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2177.refreshThumbnail(_loc1_,var_119.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_183,var_119);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_183,!true ? getEventCtg(var_119.categoryId) : getRoomCtg(var_119.categoryId));
         refreshRoomDesc(var_183,var_119);
         method_4();
         refreshInfo(var_183,"trading_allowed",var_119.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_220,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
