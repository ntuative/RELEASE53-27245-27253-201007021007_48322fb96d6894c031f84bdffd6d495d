package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_272,Tabs.const_357);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_272,Tabs.const_629);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_272,Tabs.const_357,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_506 == null)
         {
            var_506 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_506.procedure = onChangeFilter;
