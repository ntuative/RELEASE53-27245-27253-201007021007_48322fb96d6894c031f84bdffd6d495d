package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1140:int = 267;
      
      private static const const_1139:int = 65;
      
      private static const const_1141:int = -70;
       
      
      private var var_2203:PublicRoomThumbs;
      
      private var var_20:IWindowContainer;
      
      private var _navigator:HabboNavigator;
      
      private var var_874:UserCountRenderer;
      
      private var var_50:IItemListWindow;
      
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         var_2203 = new PublicRoomThumbs();
         super();
         _navigator = param1;
         var_874 = new UserCountRenderer(_navigator);
      }
      ...
      {
         var _loc4_:String = var_2203.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1141) : 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1231)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1139) : int(const_1140);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_582 || param2.type == OfficialRoomEntryData.const_698))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_874.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_355,_loc2_.tag);
         }
