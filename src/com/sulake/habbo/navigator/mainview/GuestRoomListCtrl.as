package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_1250:IWindowContainer;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1250 != null)
         {
            _loc2_ = var_1250.tags[0];
            var_1250.color = getBgColor(_loc2_);
         }
         var_1250 = param1;
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_190,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_137,null,0);
         refreshRoomName(param1,param2);
         var_874.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function method_11(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               {
                  case RoomSettingsFlatInfo.const_137:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.procedure = method_11;
         _loc2_.setParamFlag(HabboWindowParam.const_43,true);
         _loc2_.setParamFlag(HabboWindowParam.const_1326,true);
