package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1596:CutToHeight = new CutToHeight();
      
      private static var var_1597:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1597.beforeSearch(param2,param1,param3);
         binarySearch(var_1597,param2.length - 1);
      }
   }
}
