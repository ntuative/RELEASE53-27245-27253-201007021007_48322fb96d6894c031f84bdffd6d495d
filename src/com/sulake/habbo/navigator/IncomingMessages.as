package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_186,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_190 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_137 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(_navigator.configuration.getKey("roomenterad.habblet.enabled") == "ModMessageMessageComposer" && false)
         {
