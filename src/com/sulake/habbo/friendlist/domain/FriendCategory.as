package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_348:int = 100;
      ...
      {
         return Math.ceil(this.var_224.length / const_348);
      }
      ...
      {
         if(this.var_839 >= this.getPageCount())
         {
            this.var_839 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_839 + 1) * const_348,this.var_224.length);
      }
