package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1565:OpenedToWebPopup;
      
      private var var_862:IAvatarRenderManager;
      ...
      private var var_1566:AvatarSearchResults;
      ...
      private var var_1981:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_900:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1981 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_90 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1566 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_426.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_90.addCategory(new FriendCategory(FriendCategory.const_913,getText("friendlist.friends")));
         var_90.addCategory(new FriendCategory(FriendCategory.const_380,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_90.addFriend(new Friend(_loc4_));
         }
         var_426 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_508)
         {
         ...
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_862)
         {
            var_862.release(new IIDAvatarRenderManager());
            var_862 = null;
         }
         if(var_900)
         {
            var_900.release(new IIDHabboNotifications());
            var_900 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_617)
         {
            var_617.release(new IIDSessionDataManager());
            var_617 = null;
         }
         super.dispose();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = var_90.getAllFriends();
      ...
      {
         var _loc1_:String = var_126.getKey("client.minimail.embed.enabled");
         return _loc1_ == "ModMessageMessageComposer";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_426.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1566.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_617.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_617.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_426.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_862.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_426.findTab(FriendListTab.const_87);
      ...
      {
         return var_126.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1565 == null)
         {
            var_1565 = new OpenedToWebPopup(this);
         }
         var_1565.show(x,y);
      }
