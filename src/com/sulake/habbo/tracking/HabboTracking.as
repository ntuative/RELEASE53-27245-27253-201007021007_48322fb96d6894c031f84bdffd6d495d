package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_784:uint = 11;
      ...
      private var var_856:LagWarningLogger = null;
      
      private var var_857:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_486 = new FramerateTracker();
         var_228 = new LatencyTracker();
         var_856 = new LagWarningLogger();
         var_1223 = new Array(const_784);
         var _loc4_:int = 0;
         while(_loc4_ < const_784)
         {
            var_1223[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1342,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1240,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_717,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_949,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1400);
               break;
            case HabboCommunicationEvent.const_580:
               trackLoginStep(HabboLoginTrackingStep.const_1310,String(_communication.port));
               break;
      ...
      {
         var_126 = IHabboConfigurationManager(param2);
         if(var_126)
         {
            Component(var_126).events.addEventListener(HabboConfigurationEvent.const_185,onConfigurationLoaded);
            if(var_228 != null)
            {
               var_228.configuration = var_126;
            }
            if(var_227 != null)
            {
               var_227.configuration = var_126;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_267.events.addEventListener(AdEvent.const_441,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_949,String(_loc2_.guestRoomId));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_857)
            {
               var_857.release(new IIDHabboWindowManager());
               var_857 = null;
            }
            if(var_267)
            {
            ...
            if(var_174)
            {
               if(true)
               {
                  ...
                  Component(var_174).events.removeEventListener(HabboFriendListTrackingEvent.const_326,onFriendlistTrackingEvent);
               }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_580,onConnectionEvent);
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_126)
         {
            if(var_856 != null)
            {
               var_856.configure(var_126);
            }
            if(var_486 != null)
            {
               var_486.configure(var_126);
            }
            Component(var_126).events.removeEventListener(HabboConfigurationEvent.const_185,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_938);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_938,onCoreRunning);
         }
      }
      ...
      {
         var_857 = IHabboWindowManager(param2);
         if(var_857)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1503;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1503);
         }
         if(var_1044 > -1 && _loc2_ - var_1044 > 15000)
         {
            ++var_1504;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1504);
         }
         var_1044 = _loc2_;
         if(var_227 != null)
         {
         ...
         if(var_486 != null)
         {
            var_486.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_126 != null && !Boolean(var_126.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_174).events.addEventListener(HabboFriendListTrackingEvent.const_326,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_126)
            {
               if(var_126.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_126.getKey("client.fatal.error.url");
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1383);
         }
      }
   }
}
