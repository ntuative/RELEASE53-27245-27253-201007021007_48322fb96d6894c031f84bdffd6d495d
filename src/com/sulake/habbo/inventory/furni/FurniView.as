package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1755:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_542 = new Map();
         var_542.add(FurniModel.const_44,new FurniGridView(_model,FurniModel.const_44,_windowManager,_assetLibrary,_roomEngine));
         var_542.add(FurniModel.const_46,new FurniGridView(_model,FurniModel.const_46,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_310)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_775 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
