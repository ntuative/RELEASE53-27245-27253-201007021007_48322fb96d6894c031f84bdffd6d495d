package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1156:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_553 = new Timer(const_1156,1);
         var_553.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_456.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_456.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_674)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_553 != null)
            {
               var_553.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_553.stop();
               var_553 = null;
            }
            if(var_143 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_310)
         {
         ...
         if(var_800 == null)
         {
            var_800 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_800.clone() as IWindowContainer;
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_306);
      ...
      {
         if(var_970 && param1.type == RoomEngineObjectEvent.const_219)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_310 || _loc3_.category == FurniCategory.const_305 || _loc3_.category == FurniCategory.const_321)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_456.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_456 = new Map();
         var_456.add(const_44,new Array());
         var_456.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
