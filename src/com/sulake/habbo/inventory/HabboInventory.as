package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_990:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionEvent.const_109,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_444,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_109:
               var_990 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_444:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_648));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_48.getValue(InventoryCategory.const_77));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_928));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1751);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_333));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_989.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_989.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_264));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_384 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_989.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_48.getValue(InventoryCategory.const_306) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1173 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_271));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_109,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_444,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_306,_loc3_);
         ...
         var_48.add(InventoryCategory.const_77,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_384);
         var_48.add(InventoryCategory.const_271,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_648,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_384);
         var_48.add(InventoryCategory.const_333,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_264,_loc8_);
