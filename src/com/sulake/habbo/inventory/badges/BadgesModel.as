package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_995.length)
         {
            if(var_995[_loc2_] == param1)
            {
               var_995.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_297[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_297.length)
               {
                  if((var_297[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_297[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_384.getBadgeImage(param1);
            var_297.push(_loc8_);
            if(param2)
            {
