package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_657.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_335 != null)
         {
            var_335.setSelected(false);
         }
         var_335 = param1;
         if(var_335 != null)
         {
            var_335.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_335.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_657.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_657.getValue(param1.id) != null)
         {
            return;
         }
