package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2401:BitmapData;
      
      protected var var_1008:Boolean;
      ...
      protected var var_391:BitmapData;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_674)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1493));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1472);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1471 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2401;
               _loc5_.visible = true;
            }
            else
            {
