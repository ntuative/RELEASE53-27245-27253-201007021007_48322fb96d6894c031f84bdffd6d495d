package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_77,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_648);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_306))
         {
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_77);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_264);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_271);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_306);
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
