package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private function showConfirmation() : void
      {
         ...
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1638.toString());
      ...
      {
         var _loc1_:* = null;
         if(false && "ModMessageMessageComposer" == _config.getKey("client.credits.embed.enabled"))
         {
