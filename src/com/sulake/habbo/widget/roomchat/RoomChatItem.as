package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1146:Number = 18;
      
      private static const const_1484:Number = 10;
      
      private static const const_1483:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1152,var_1153,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1152,var_791,var_1153,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1400 = param1.chatType;
         var_1152 = param1.userId;
         var_791 = param1.userName;
         var_1153 = param1.userCategory;
         _message = param1.text;
         var_1401 = param1.userX;
         var_213 = param1.userImage;
         var_1154 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1154 != 0)
            {
               _loc30_ = uint(var_1154 >> 16 & 255);
               _loc31_ = uint(var_1154 >> 8 & 255);
               _loc32_ = uint(var_1154 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1400 == RoomWidgetChatUpdateEvent.const_251)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_791);
            }
            else if(var_1400 == RoomWidgetChatUpdateEvent.const_289)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_369 + _loc20_.textWidth + const_525;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1152,var_1153,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1152,var_1153,_roomId,_roomCategory,param1);
      }
