package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_375:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1076 = new Map();
         var_376 = new Timer(const_1734);
         var_376.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function createCommandWindow() : void
      {
         ...
         var_42.setParamFlag(WindowParam.const_86,true);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_767,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_375 == null)
         {
            ...
            var_375 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_375 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_375.x = 200;
            var_375.procedure = onInfoWindowProcedure;
         }
         else
         {
            var_375.visible = true;
         }
      }
      
      private function onButtonDisableTimeout(param1:TimerEvent) : void
      {
         var _loc2_:Array = var_1076.getValue(var_640) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_449,var_640));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_751,var_640,var_2206 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1076.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_640);
         }
         else
         {
