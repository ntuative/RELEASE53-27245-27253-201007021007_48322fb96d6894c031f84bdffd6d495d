package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1742:String = "level";
      ...
      private const const_1737:String = "nutrition";
      ...
      private const const_1741:int = 158;
      
      private const const_1744:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_185:PetCommandTool;
      
      private const const_1743:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_239 != null)
         {
            var_108 = var_239.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_108 == null || var_239 == null || var_63 == null)
         {
            return;
         }
         ...
         var_239.height = NaN;
         _window.width = Math.max(var_239.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1215.getValue(var_640) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1742,param1.level,param1.levelMax);
         ...
         updateStateElement(const_1737,param1.nutrition,param1.nutritionMax);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_185 && var_185.getPetId() == var_640)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_510,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1741,const_1744,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1743);
