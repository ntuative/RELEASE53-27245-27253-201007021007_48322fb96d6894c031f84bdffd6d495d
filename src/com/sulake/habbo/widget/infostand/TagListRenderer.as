package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1726:int = 5;
      
      private const const_1725:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1275 != null && var_1275.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_884 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_884 += param1.height + const_1725;
            return fit(param1);
         }
         param1.offset(_offsetX,var_884);
         _offsetX += param1.width + const_1726;
         return true;
      }
