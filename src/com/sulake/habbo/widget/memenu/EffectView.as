   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_876 = _window.findChildByName("effect_hilite");
            var_876.visible = false;
         }
         var_877 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_875 = _window.findChildByName("loader_bar");
         if(var_875 != null)
         {
            var_422 = var_875.width;
            var_184.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_877 != null)
         {
            var_877.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_877.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
