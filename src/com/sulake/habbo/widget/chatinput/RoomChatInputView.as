package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1155:int = 20;
      ...
      private var var_422:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1158 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2312 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2313 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_799 = new Timer(1000,1);
         var_799.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_968 = new Timer(5000,1);
         var_968.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2311 = _loc2_.width + const_525 + _loc6_.width + const_1155;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1154,_loc8_.width) + const_525);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1158 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_142 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_422);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_422);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_551);
