package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1082,const_1081,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1061 = _loc2_.light;
         if(var_350 != null)
         {
            var_350.setValue(var_1061);
         }
         var_462 = colors.indexOf(_loc2_.color);
         if(var_497 != null)
         {
            var_497.setSelectedColorIndex(var_462);
         }
