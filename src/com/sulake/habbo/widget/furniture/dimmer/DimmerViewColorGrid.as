package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_459:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_459.destroyGridItems();
         var_335 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1430) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_562.width;
            _loc3_.height = var_562.height;
            var_459.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_562.width,var_562.height,true,0);
               _loc4_.bitmap.copyPixels(var_562,var_562.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_976.width,var_976.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_805.width,var_805.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_805,var_805.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_459.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_459.numGridItems)
         {
            return;
         }
         select(var_459.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_335 != null)
         {
            _loc2_ = var_335.getChildByName("chosen");
            if(_loc2_ != null)
            {
