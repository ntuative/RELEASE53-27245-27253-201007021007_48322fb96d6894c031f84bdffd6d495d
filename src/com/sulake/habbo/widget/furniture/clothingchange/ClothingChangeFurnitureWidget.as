package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_329,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_925,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_335,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_329:
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1747 = param1.objectCategory;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_329,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_925,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_335,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_648 = _loc4_;
         var_648.offset(100,100);
         var _loc6_:IWindow = var_648.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_327,param1,var_165,var_1747,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_648 != null)
         {
            _loc1_ = var_648 as IFrameWindow;
            if(_loc1_ != null)
            {
