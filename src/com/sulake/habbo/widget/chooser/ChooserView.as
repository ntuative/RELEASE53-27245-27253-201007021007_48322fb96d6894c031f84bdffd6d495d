package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1473:uint = 0;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1617);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_769)
         {
            return;
         }
         if(var_769 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_769) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_769 % 2) ? uint(const_1473) : uint(const_1474);
            }
         }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1473) : uint(const_1474);
