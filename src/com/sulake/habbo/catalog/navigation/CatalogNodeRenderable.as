package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1125:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1606:XML;
      
      private static var var_1607:XML;
       
      
      private var var_2450:IWindowContainer;
      ...
      private var var_1605:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1605 == 4294967295)
            {
               var_1605 = _loc1_.color;
            }
            _loc1_.color = const_1125;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1276;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1606) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1607) as IItemListWindow;
         if(var_50 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1296;
            }
         }
      }
