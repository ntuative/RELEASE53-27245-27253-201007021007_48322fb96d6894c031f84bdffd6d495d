package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2524:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_562,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_287,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","ModeratorActionResultMessageParser") == "ModMessageMessageComposer";
         if(false && _loc1_)
         {
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_295.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = var_295.indexOf(_loc6_);
            var_295.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
