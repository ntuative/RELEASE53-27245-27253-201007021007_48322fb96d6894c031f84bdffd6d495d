package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1620:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_400 != null)
         {
            if(var_400.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_400.window);
            var_400.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1620);
         var_400 = _loc5_;
      ...
      {
         return var_400.dispatchWidgetEvent(param1);
      }
