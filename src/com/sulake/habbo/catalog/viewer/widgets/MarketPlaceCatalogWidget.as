package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_940:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!var_536)
         {
            ...
            var_536 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_536)
         {
            return;
         ...
         if(!var_441)
         {
            var_441 = new Timer(25);
            var_441.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_939 = 0;
         populateList();
         var_441.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_536 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_536.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_442.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_441)
         {
            var_441.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_441 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_939 >= var_608.length)
            {
               return true;
            }
            addListItem(var_608.getWithIndex(var_939));
            ++var_939;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_940.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_442));
            _loc7_.selection = 0;
         }
      }
