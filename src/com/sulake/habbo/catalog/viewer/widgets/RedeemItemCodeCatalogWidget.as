package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1057 != null)
         {
            var_1057.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1058 != null)
         {
            var_1058.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1057 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1057 != null)
         {
            var_1057.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1058 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1058 != null)
         {
            var_1058.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
