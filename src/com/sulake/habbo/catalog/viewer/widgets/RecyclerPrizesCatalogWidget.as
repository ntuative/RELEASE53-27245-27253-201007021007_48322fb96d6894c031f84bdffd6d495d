package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1247:XML;
      
      private var var_335:IGridItem;
      
      private var var_1246:XML;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_721[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_721 = recycler.getPrizeTable();
         if(var_721 == null)
         {
            return;
         }
         ...
         var_1247 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_721[0].prizes.length > 0)
         {
            select(var_721[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1247) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1246) as IWindowContainer;
