package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1359:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1359.text = "${" + _loc3_.name + "}";
            var_1360.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1359.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_468:
                  _loc4_ = var_1380.clone();
                  if(var_638 != null)
                  {
                     var_638.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_638,var_1381,var_1246);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_231:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_286,AvatarAction.const_464);
                              _loc13_.appendAction(AvatarAction.const_434,_loc6_.productClassId);
      ...
      {
         var_1359 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1360 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1645 = new Point(var_88.x,var_88.y);
         var_638 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1381 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_638 == null)
         {
         ...
         var_1380 = _loc2_.content as BitmapData;
