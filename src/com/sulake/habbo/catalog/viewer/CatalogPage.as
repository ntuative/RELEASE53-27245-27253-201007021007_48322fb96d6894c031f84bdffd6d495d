package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1451:String = "ctlg_";
      ...
      private var var_1423:EventDispatcher;
      ...
      {
         var _loc2_:String = const_1451 + param1;
         ...
         var_1479 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1479) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_974);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1425) as IWindowContainer;
         if(_loc1_ != null)
         {
            var_55.push(new PetsCatalogWidget(_loc1_));
         }
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1430) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1423;
            _loc2_.init();
         }
         var_1423.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1423.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_974);
      }
