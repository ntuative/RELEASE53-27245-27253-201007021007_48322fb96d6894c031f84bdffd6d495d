package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_1872:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1664,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1873 || param1.furniTypeId != var_1868)
         {
            return;
         }
         var_1872 = param1;
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1870 = _loc3_.creditsWaiting;
         var_198 = new Map();
      ...
      {
         requestOffers(var_1871,var_1867,var_1866,var_1869);
      }
