package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1473:uint = 4.294967295E9;
      
      private const const_1474:uint = 4.293848814E9;
      
      private var var_980:int;
      
      private const const_1747:uint = 4.291613146E9;
      ...
      private const const_1748:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_631:
               showSelectors(false);
               break;
            case WindowEvent.const_740:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_250.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_979;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_979,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1474) : uint(const_1473);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_400,var_77,var_1167);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_250.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_293) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_979);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_665[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_666[var_218]);
         _catalog.purchaseProductAsGift(var_400,var_77,var_1167,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_132:
               ...
               for each(_loc7_ in var_224)
               {
                  ...
                  if(_loc5_.length >= const_1748)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2351 = _loc3_.text;
               break;
            case WindowMouseEvent.const_55:
               showSuggestions(false);
               if(var_1433)
               ...
               break;
            case WindowKeyboardEvent.const_592:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_293 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_293 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_665 = _loc1_.boxTypes;
            var_666 = _loc1_.ribbonTypes;
            var_979 = var_1637[0];
            _boxIndex = var_665[0];
            var_218 = var_666[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_250.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_293) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_293);
         }
         var_293 = param1;
         if(var_293 < 0)
         {
            var_293 = _loc2_.numListItems - 1;
         }
         if(var_293 >= _loc2_.numListItems)
         {
            var_293 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_293) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_250 == null)
         {
            var_250 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_564 == null)
         {
            var_564 = createWindow("suggestion_list_item") as IWindowContainer;
            var_564.procedure = suggestionsEventHandler;
         }
         if(var_250 == null || var_564 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_250.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_564.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
