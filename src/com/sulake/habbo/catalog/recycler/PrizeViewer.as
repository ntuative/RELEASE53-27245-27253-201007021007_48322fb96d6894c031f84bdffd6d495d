   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_294 != null && true)
         {
            ...
            var_294.bitmap = new BitmapData(var_294.width,var_294.height,true,16777215);
            var_294.bitmap.fillRect(var_294.bitmap.rect,16777215);
            _loc3_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_294.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         var_294 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
