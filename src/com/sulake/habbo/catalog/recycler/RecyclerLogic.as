package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_819:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1674)
         {
            case RecyclerStatusMessageEvent.const_1192:
               ...
               break;
            case RecyclerStatusMessageEvent.const_869:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1674 != RecyclerStatusMessageEvent.const_869;
      }
      
      private function get statusActive() : Boolean
      {
         return var_292 != const_819;
      }
      ...
      {
         return active && var_292 == const_370;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_922:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1339:
