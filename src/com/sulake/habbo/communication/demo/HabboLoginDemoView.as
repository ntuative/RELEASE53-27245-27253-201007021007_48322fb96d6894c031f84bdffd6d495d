package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_120.removeEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_120.removeEventListener(SSOTicket.const_295,onParsedTicketFailure);
         var_120 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_187.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_112,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(false)
         {
            if(var_187.habboConfiguration.getKey("use.sso","ModeratorActionResultMessageParser") == "ModMessageMessageComposer")
            {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_120.addEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_120.addEventListener(SSOTicket.const_295,onParsedTicketFailure);
      }
