   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_500));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_740.loadAssetFromFile("hotel_view_banner_" + var_888,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
