package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_960 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_154 ? var_140.conversations.findConversation(param2.id) : var_140.conversations.openConversations[_loc3_ + var_140.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         var _loc3_:IWindowContainer = var_960.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
         refreshArrow(_loc3_,param1,param2);
         refreshTabBg(_loc3_,param1,!!param2 ? "tab_bg_next" : "tab_bg_unsel");
         var _loc4_:int = 0 % var_1392;
         _loc3_.width = var_1392 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * var_1392;
         _loc3_.width = var_1392;
         return false;
      }
   }
}
