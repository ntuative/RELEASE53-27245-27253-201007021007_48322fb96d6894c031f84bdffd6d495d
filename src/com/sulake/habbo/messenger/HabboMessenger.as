package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_606:Conversations;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_933,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_606.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_606.setSelected(_loc2_);
            var_231.openMessenger();
            var_231.refresh();
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_126.getKey("url.prefix",_loc2_);
      ...
      {
         var_606.addMessageAndUpdateView(param1);
         if(!var_231.isMessengerOpen())
         {
      ...
      {
         var_606 = new Conversations(new ConversationsDeps(this));
         var_231 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_186,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_606.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_606.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1022,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_606.addMessageAndUpdateView(_loc3_);
      }
