package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1132:int = 20;
      
      private static const const_807:int = 100;
       
      
      private var var_2161:IScrollbarWindow;
      
      private var var_140:HabboMessenger;
      
      private var var_1636:IContainerButtonWindow;
      
      private var var_543:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_140 = param1;
         var_1636 = initButton("follow_friend",onFollowButtonClick,param2);
         var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2161 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_657 || param3.type == Message.const_729 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_543.messages.length - const_807);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_543.messages.length)
         {
            refreshEntry(true,_loc1_,var_543.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_543 == null || _loc1_.id != var_543.id)
         {
            var_543 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_807 + const_1132)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_140.send(new FollowFriendMessageComposer(var_543.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1131;
         param1.invalidate();
      }
   }
}
