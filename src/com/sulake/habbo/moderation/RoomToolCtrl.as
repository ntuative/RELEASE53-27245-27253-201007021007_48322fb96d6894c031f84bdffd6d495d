package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1022:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_670,_data.flatId),var_51,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1419,_loc2_,var_469.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1022.isSelected,var_1023.isSelected,var_695.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1348);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1321);
      }
      ...
      public function populate() : void
      {
         ...
         var_1022 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1023 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
