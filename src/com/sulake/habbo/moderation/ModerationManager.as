package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1890:ModeratorInitData;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1888:WindowTracker;
      ...
      private var var_1891:ModerationMessageHandler;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1891 = new ModerationMessageHandler(this);
         }
      }
