package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_403:UserInfoCtrl;
      
      private var var_59:ModerationManager;
      
      private var var_1039:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_403 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1039 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_403.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_113.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1039.load(_loc4_,var_113.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_856,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_403 = new UserInfoCtrl(_window,var_59,_loc3_.message);
            var_403.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
