package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1609:IIssueBrowserView;
      
      private const const_1727:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1729:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1610:IIssueBrowserView;
      
      private const const_1754:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1728:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_245:ITabContextWindow;
      
      private var var_1608:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_370.view.width = var_245.container.width;
         var_370.view.height = var_245.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1728:
               if(var_1610 == null)
               {
                  var_1610 = new MyIssuesView(issueManager,this,var_245.container);
               }
               return var_1610;
            case const_1727:
               if(var_1609 == null)
               {
                  var_1609 = new OpenIssuesView(issueManager,this,var_245.container);
               }
               return var_1609;
            case const_1729:
               if(var_1608 == null)
               {
                  var_1608 = new PickedIssuesView(issueManager,this,var_245.container);
               }
               return var_1608;
            default:
               return null;
