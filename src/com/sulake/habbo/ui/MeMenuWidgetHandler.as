package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_696:
               ...
               break;
            case RoomWidgetWaveMessage.const_664:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_720:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_692:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_718:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1005)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_203,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_585:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_942:
                        _catalog.openCatalogPage(CatalogPageName.const_1297,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_862:
                        var_11.toggleInventoryPage(InventoryCategory.const_271);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1322:
                        var_11.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1187:
                        break;
                     default:
            ...
            case RoomWidgetToolbarMessage.const_543:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_397,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            ...
            case RoomWidgetAvatarEditorMessage.const_589:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_395));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_327:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_632));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_467:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_399));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_467,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_193,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_928,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_983,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_467,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_664);
         _loc1_.push(RoomWidgetDanceMessage.const_720);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_585);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_718);
         _loc1_.push(RoomWidgetStopEffectMessage.const_636);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1298);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_852);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1368);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_859);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_647);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_696);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_643);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1193);
         ...
         _loc1_.push(RoomWidgetClothingChangeMessage.const_327);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_617));
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_890,HabboToolbarIconEnum.MEMENU);
