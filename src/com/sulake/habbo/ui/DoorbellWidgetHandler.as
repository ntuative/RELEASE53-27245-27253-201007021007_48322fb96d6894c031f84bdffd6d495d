package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_113:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_732,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_567];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_567:
      ...
      {
         return [RoomSessionDoorbellEvent.const_113,RoomSessionDoorbellEvent.const_116,RoomSessionDoorbellEvent.const_56];
      }
