package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_552);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_346);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_867);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_919);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_898)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_428);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_221)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_747);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1229;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1041;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1044;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1282);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_623.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_54);
            var_623.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_537);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_639);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_553);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1423);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_701:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1003,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_263:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_537:
            ...
            case RoomWidgetRoomTagSearchMessage.const_639:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_553:
