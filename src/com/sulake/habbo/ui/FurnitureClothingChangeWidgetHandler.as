package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1157:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      
      private static const const_1158:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_764,RoomWidgetClothingChangeMessage.const_327,RoomWidgetAvatarEditorMessage.const_336];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_764:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_329,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_327:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1058);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1158;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_837);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1157;
                        }
                     }
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_213,AvatarEditorFigureCategory.const_685],true))
                     {
                        _loc11_ = 0;
                        ...
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_329,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        _container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
