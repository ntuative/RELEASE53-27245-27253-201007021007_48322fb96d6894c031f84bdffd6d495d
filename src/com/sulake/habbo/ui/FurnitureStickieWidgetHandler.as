package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_726,RoomWidgetStickieSendUpdateMessage.const_663,RoomWidgetStickieSendUpdateMessage.const_455];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_726:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1029);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
            ...
            case RoomWidgetStickieSendUpdateMessage.const_455:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_663:
