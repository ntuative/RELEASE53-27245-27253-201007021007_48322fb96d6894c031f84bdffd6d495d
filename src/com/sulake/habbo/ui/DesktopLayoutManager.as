package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1745:String = "room_widget";
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_793;
               _loc2_.width = var_54.desktop.width - var_793;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_793;
               _loc2_.height = var_54.desktop.height - var_793;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_54.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_54.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_261,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1745) == 0)
            {
