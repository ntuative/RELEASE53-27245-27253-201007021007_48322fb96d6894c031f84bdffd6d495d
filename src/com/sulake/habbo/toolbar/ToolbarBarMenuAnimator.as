package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_812:int = 50;
      ...
      private var var_1145:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1145 = param2;
         var_647 = new Timer(const_1144);
         var_647.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_548.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_548.splice(_loc3_,1);
            var_549.splice(_loc3_,1);
         }
         var_549.push(param1.name);
         var_548.push(param2);
      ...
      {
         return var_548[var_549.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1145.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_332.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_332.splice(var_332.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1145.getIconLoc(param1.iconId);
      ...
      {
         return var_549[var_548.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_332[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_646[_loc3_] = new Array();
            }
            if(var_646[_loc3_].indexOf(param1) < 0)
            {
               var_646[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_812 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_812 || param1.desktop.height - param1.y < const_1143;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_549[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_646[_loc3_].length)
                  {
                     repositionWindow(var_646[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
