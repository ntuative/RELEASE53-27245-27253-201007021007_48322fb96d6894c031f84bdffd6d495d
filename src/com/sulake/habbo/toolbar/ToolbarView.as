package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_146 = _window.width;
         var_219 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_843,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1174 = String(_loc7_.relocate_by_drag.@state) == "ModMessageMessageComposer";
         if(var_1174)
         {
         ...
         var_1448 = _loc7_.toolbar.@margin_bottom;
         var_1698 = _loc7_.toolbar.@min_group_margin;
         var_1697 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_298,param1,param2,_window,var_289);
         createGroupsFromXmlList(_loc9_,var_673,param1,param2,var_219,var_289);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_146,var_571,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_146;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_219.x = var_146 + var_1697;
               var_219.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_146;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_146;
               _window.y = 0;
               var_219.x = 0;
               var_219.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_146;
               _window.x = 0;
               _window.y = 0;
               var_219.x = 0;
               var_219.y = var_146 + var_1697;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_146;
               _window.x = 0;
               _window.y = _loc1_.height - var_146;
               var_219.x = 0;
               var_219.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1698,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1448) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1698,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1448) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_146);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_146)
         {
            return "RIGHT";
         }
         if(param2 <= var_146)
         ...
         if(param2 >= _loc3_.height - var_146)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_146,var_571);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_146,var_571);
         }
      }
