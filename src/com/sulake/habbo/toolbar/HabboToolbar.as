package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_337.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         ...
         if(_view != null && var_36)
         {
            ...
            {
               _loc2_ = method_6(param1.iconId,param1.assetName);
      ...
      private function method_6(param1:String, param2:String = null) : BitmapData
      {
         if(param2 == null)
         {
            switch(param1)
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_186,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_397,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_708,onDisplayWindowEvent);
