package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_752:Number = 0.0;
      
      private var var_366:int = 0;
      
      private var var_365:int = 0;
      
      private var var_1325:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_835;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_284,param1,param2,param3,[param4]);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_752 = getFloorHeight(var_109);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_365 || param1 == var_364)
               {
                  _loc5_ = false;
                  _loc6_ = var_366;
                  while(_loc6_ < var_363)
                  {
               ...
               if(param2 == var_366 || param2 == var_363)
               {
                  _loc7_ = false;
                  _loc8_ = var_365;
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_165,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_165,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_165,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_165,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_165,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
