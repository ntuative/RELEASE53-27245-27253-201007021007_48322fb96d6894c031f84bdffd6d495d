package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      private var var_904:BitmapDataAsset;
      ...
      {
         super();
         var_904 = param1.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
      }
      ...
      public function setExperience(param1:int) : void
      {
         ...
         _image = (var_904.content as BitmapData).clone();
