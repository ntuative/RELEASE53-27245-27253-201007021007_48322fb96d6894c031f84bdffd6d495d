package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1030[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1033[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1030 = new Array();
         var_1030.push(Math.random() * _loc2_ * 1.5);
         var_1030.push(Math.random() * _loc2_ * 1.5);
         var_1031 = new Array();
         var_1031.push(1);
         var_1031.push(-1);
         var_1032 = new Array();
         var_1032.push(const_1079);
         var_1032.push(const_1080);
         var_1033 = new Array();
         var_1033.push(getRandomAmplitudeFactor());
         var_1033.push(getRandomAmplitudeFactor());
      }
