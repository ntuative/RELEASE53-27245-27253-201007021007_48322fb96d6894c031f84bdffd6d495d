package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_939);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_223 != null)
         {
            ...
            {
               _loc2_ = var_223[_loc3_];
               _loc2_.update(var_588,var_1738,param1);
               _loc3_++;
            }
