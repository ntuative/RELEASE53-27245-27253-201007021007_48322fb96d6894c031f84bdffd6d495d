package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_814:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1454 / 2) % 360 / var_1454;
         if(var_253.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_253.length)
         {
            _loc6_ = int(var_253.getKey(_loc5_)) * var_1454;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_253.getKey(_loc4_));
         }
         return const_1207;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_253.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_253 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < var_253.length)
            {
               _loc2_ = var_253.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_253.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_253.add(String(_loc7_),_loc3_);
            var_1455 = -1;
            var_814 = null;
            _loc5_++;
         }
