package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1097:LayoutRasterizerData = null;
      ...
      private var var_519:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_914:IGraphicAssetCollection;
      
      private var var_1256:XMLList;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1095 = param1;
         var _loc3_:LayoutRasterizerData = var_39.getValue(var_759);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1307 = RoomObjectVariableEnum.const_1055;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1307 = RoomObjectVariableEnum.const_878;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1307);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2021);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_759)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1097 = var_39.getValue(var_759);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_39.getValue(var_759);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1097.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_914.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1096.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1096.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_361.indexOf(_loc10_) >= 0 && var_519)
            {
               param1 = var_361.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_914.getAsset(var_521[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
