         ...
         if(var_545 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_1131,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_1131,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_1131,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_776[_loc6_ % 0] as IGraphicAsset;
