package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc5_:String = _loc4_.getString(RoomObjectVariableEnum.const_344);
         var _loc6_:* = !Boolean(_loc4_.getNumber(RoomObjectVariableEnum.const_412));
         if(_loc5_ != "" && data != null)
         {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(data != null)
         {
            ...
            {
               data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + var_1194));
               _loc4_++;
            }
            data.layoutRasterizer.initializeAds(var_1194,this);
         }
         var_2141 = true;
      }
