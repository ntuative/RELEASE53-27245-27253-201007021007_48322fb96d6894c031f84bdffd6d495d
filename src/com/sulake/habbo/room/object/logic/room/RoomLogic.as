package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1557:int = 1500;
      
      private var var_1556:int = 255;
      
      private var var_1555:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_900,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_695,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_757,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_745,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_686,1);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_941:
               param2.setNumber(RoomObjectVariableEnum.const_757,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_839:
               param2.setNumber(RoomObjectVariableEnum.const_745,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_686,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_471:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_237)
               {
                  _loc5_ = "null";
               }
               var_438.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_748:
               _loc4_ = var_438.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_438.getXML();
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_669:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_683:
               param2.setString(RoomObjectVariableEnum.const_719,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_893)
         {
            ...
            {
               _loc7_ = var_1280 >> 16 & 255;
               _loc8_ = var_1280 >> 8 & 255;
               _loc9_ = var_1280 & 255;
               _loc10_ = var_1074 >> 16 & 255;
               _loc11_ = var_1074 >> 8 & 255;
               _loc12_ = var_1074 & 255;
               _loc13_ = (_loc2_ - var_893) / var_1557;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1556 + (var_1555 - var_1556) * _loc13_;
               _color = _loc3_;
               var_1321 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_695,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1432,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1426,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1227,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_157 || _loc13_ == RoomPlaneData.const_284)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
