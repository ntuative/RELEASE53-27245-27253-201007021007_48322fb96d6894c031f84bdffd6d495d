package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_693,"");
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1028:
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_693,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_412,Number(true));
                  var_1060 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_967);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_693);
