package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_132:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(var_424.getValue(_loc4_) == null)
               {
                  var_424.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(var_1088.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(var_1087.indexOf(_loc6_) == -1)
               {
                  ...
                  var_257.push(_loc8_);
                  var_1087.push(_loc6_);
                  if(param3 != null && var_706.indexOf(param3) == -1)
                  {
                     var_706.push(param3);
                  }
               }
      ...
      {
         var _loc3_:IPetData = var_424.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_706.pop() as IPetDataListener;
            if(_loc1_ != null)
            {
               _loc1_.petDataReady();
            }
      ...
      {
         var _loc4_:PetData = var_424.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_424.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_424.getValue(key);
            if(petData != null)
            {
