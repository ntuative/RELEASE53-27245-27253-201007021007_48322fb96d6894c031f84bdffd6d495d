package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1521:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_864 = new Vector3D(0,0,10,0);
         super();
         var_493 = new Matrix4x4();
         var_718 = new Dictionary();
         var_1521 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_718[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(var_493,var_864,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1521.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_141[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         for each(_loc8_ in _loc6_)
         {
            ...
            _loc10_ = _loc8_.getDistance(var_864);
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1521.findAvatarSet(param1);
         if(_loc3_ != null)
         {
