package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_965:IAvatarImage;
      ...
      {
         if(var_584 == param1 || var_584 == GeometryType.const_923 && param1 == GeometryType.const_960 || param1 == GeometryType.const_923 && var_584 == GeometryType.const_960)
         {
            var_584 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_597)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_466)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,var_965.getFigure(),_loc6_,var_584,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_152,var_584);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1429[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_897 || _loc30_ == AvatarAction.const_406) && (_loc6_ == AvatarBodyPartType.const_213 || _loc6_ == AvatarBodyPartType.const_1418 || _loc6_ == AvatarBodyPartType.const_1364) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_152 == AvatarScaleType.const_54)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_124 != null)
         {
            ...
            {
               _loc5_ = var_124.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
