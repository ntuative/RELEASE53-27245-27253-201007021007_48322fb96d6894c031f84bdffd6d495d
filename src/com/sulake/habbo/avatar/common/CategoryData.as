package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_737 >= 0 && var_176.length > var_737)
         {
            _loc2_ = var_176[var_737];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_201.length)
         {
            ...
            {
               if(_loc7_.length > var_201[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_201[param2],param2);
         var_201[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_201[param1])
         {
            return null;
         }
      ...
      {
         return var_176[var_737] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_201 = new Array(param1.length);
         var _loc3_:int = 0;
