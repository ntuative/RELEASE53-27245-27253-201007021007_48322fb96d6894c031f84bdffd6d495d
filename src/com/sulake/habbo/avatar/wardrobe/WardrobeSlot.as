package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_411 && var_1244)
         {
            _loc5_ = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_607,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_668));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_411 = _controller.figureData.getFigureString();
               var_607 = _controller.gender;
               _controller.handler.saveWardrobeOutfit(var_1528,this);
               updateView();
               break;
            case "get_button":
               if(var_411)
               {
                  _controller.loadAvatarInEditor(var_411,var_607,_controller.clubMemberLevel);
               }
         }
      }
