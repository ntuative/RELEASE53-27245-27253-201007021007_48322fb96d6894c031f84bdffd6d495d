package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_790:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_790 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1151 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_790)
         {
            var_790.removeListItems();
         }
         if(var_1151)
         {
            var_1151.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_790)
               {
                  var_790.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1151)
            {
               var_1151.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
