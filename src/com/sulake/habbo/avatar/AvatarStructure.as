package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1575:PartOffsetData;
      
      private var var_905:AvatarActionManager;
      
      private var var_177:IAssetLibrary;
      
      private var var_906:IAssetLibrary;
      
      private var var_427:AvatarRenderManager;
      
      private var var_318:FigureData;
      
      private var var_674:AnimationData;
      ...
      private var var_754:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_674 = new AnimationData();
         var_1574 = new AvatarStructureDownloadSet();
         var_754 = new AnimationManager();
         var_619 = param4;
         var_1575 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_905.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_905.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_905.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_754.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_425.addPartDefinition(_loc11_);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_905.getDefaultAction();
         var _loc9_:Array = var_425.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_754.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_674.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_425.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_425.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         if(var_619 == AvatarType.const_80)
         {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_619)
         {
            case AvatarType.const_80:
               ...
               var_1574.add(new AvatarStructureDownload(var_177,_loc5_,var_318));
               break;
            case AvatarType.PET:
         }
      ...
      {
         return var_754.getAnimation(param1);
      }
      ...
      {
         var_905 = new AvatarActionManager(var_177,var_619);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1295 = var_318.getMandatorySetTypeIds();
         return var_1295;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_906.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_906.getAssetByName("dance" + _loc1_).content as XML;
            var_754.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_906.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_906.getAssetByName("fx" + _loc1_).content as XML;
            var_754.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var_1575.loadOffsets(var_906);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_905.sortActions(param1);
      }
   }
}
