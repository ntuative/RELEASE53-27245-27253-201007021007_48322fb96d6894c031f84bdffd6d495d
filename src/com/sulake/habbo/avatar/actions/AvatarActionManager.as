package com.sulake.habbo.avatar.actions
{
   ...
   public class AvatarActionManager
   {
      ...
      private var var_919:ActionDefinition;
      ...
      private function method_5(param1:Array) : Array
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:int = 0;
         ...
         while(_loc6_ < param1.length)
         {
            ...
            _loc5_ = var_243[_loc4_.actionType] as ActionDefinition;
            if(_loc5_ != null)
            {
      ...
      public function sortActions(param1:Array) : Array
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         param1 = method_5(param1);
         var _loc2_:Array = new Array();
         for each(_loc3_ in param1)
         {
            _loc4_ = var_243[_loc3_.actionType];
            if(_loc4_ != null)
            {
      ...
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            _loc6_ = var_243[_loc5_.actionType] as ActionDefinition;
