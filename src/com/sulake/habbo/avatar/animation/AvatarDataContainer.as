package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1576:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_1949 = parseInt(_loc2_,16);
         var_1950 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1577,var_1576,var_1579,_alphaMultiplier);
         var_1068 = generatePaletteMapForGrayscale(var_1950,var_1949);
      }
      
      public function get reds() : Array
      {
         return var_1068.getValue("reds") as Array;
      }
      ...
      {
         return var_1068.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1068.getValue("greens") as Array;
      }
      ...
      {
         return var_1068.getValue("alphas") as Array;
      }
