package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1468:IWindowContainer;
      
      public static var var_2392:int = 6710886;
      ...
      private var var_568:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_569:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1169 = [];
         var_1143 = [AvatarEditorFigureCategory.const_758,AvatarEditorFigureCategory.const_45,AvatarEditorFigureCategory.const_213,AvatarEditorFigureCategory.const_685,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_93];
         super();
         _controller = param1;
         ...
         if(var_1468 == null)
         {
            ...
            var_1468 = _controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1704 == null)
         {
            _loc8_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1704 = _controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(_controller.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1685 == AvatarEditorSideCategory.const_93 || var_2354))
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_569)
         {
            ...
            var_569 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_569.procedure = stripClubDialogEventProc;
            var_569.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_568 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_568.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1169.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_568.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_568.numSelectables)
               {
                  var_568.getSelectableAt(_loc6_).x = var_568.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1143);
         }
         if(param1.length != var_1169.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1169.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_476:
               _loc3_ = _controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_476);
               break;
      ...
      {
         if(var_1685 == AvatarEditorSideCategory.const_93)
         {
            var_2354 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_261 = param1;
         var_568.setSelected(var_568.getSelectableByName(param1));
         _window.invalidate();
      }
