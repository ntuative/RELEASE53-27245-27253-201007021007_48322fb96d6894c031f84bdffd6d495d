package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_496 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_96 = parseIdle;
      ...
      {
         if(var_496.parse(param1))
         {
            var_46.push(var_496);
            if(false)
            {
               var_128["null"] = var_496;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1254,var_496));
            var_496 = null;
            if(var_96 != parseIdle)
            {
               var_96 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_128 != null && param1 < var_46.length)
         {
